...
try {
		Debug.PushSubsStack("BoolsToList (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,477);
...
try {
		Debug.PushSubsStack("BytesToList (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,488);
...
try {
		Debug.PushSubsStack("Camera_PreviewCaptureComplete (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,308);
...
__ref.setField ("_focusstate" /*RemoteObject*/ ,__ref.runClassMethod (com.modis.camex2.class, "_inttoconst" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.modis.camex2.class, "_getfromcaptureresult" /*RemoteObject*/ ,(Object)(_captureresult),(Object)(RemoteObject.createImmutable("CONTROL_AF_STATE")))),(Object)(__ref.getField(false,"_af_state" /*RemoteObject*/ ))));
...
try {
		Debug.PushSubsStack("CloseSession (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,72);
...
_session = __ref.getField(false,"_jcamera" /*RemoteObject*/ ).runMethod(false,"GetFieldJO",(Object)(RemoteObject.createImmutable("captureSession")));Debug.locals.put("session", _session);Debug.locals.put("session", _session);
...
Debug.ShouldStop(4096);
__ref.getField(false,"_jcamera" /*RemoteObject*/ ).runVoidMethod ("SetField",(Object)(BA.ObjectToString("captureSession")),(Object)(camex2.__c.getField(false,"Null")));
 };
...
try {
		Debug.PushSubsStack("CreateSurface (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,143);
if (RapidSub.canDelegate("createsurface")) { return __ref.runUserSub(false, "camex2","createsurface", __ref);}
...
public ResumableSub_CreateSurface(com.modis.camex2 parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
//if
this.state = 6;
if (__ref.getField(false,"_tv" /*RemoteObject*/ ).runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
this.state = 3;
;}if (true) break;
...
//C
this.state = 6;
__ref.getField(false,"_tv" /*RemoteObject*/ ).runVoidMethod ("RemoveView");
if (true) break;
...
Debug.ShouldStop(65536);
__ref.setField ("_tv" /*RemoteObject*/ ,__ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"CreateSurface",__ref.getField(false, "ba")));
 BA.debugLineNum = 146;BA.debugLine="mPanel.AddView(tv, 0, 0, mPanel.Width, mPanel.Hei";
Debug.ShouldStop(131072);
__ref.getField(false,"_mpanel" /*RemoteObject*/ ).runVoidMethod ("AddView",(Object)((__ref.getField(false,"_tv" /*RemoteObject*/ ).getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_mpanel" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(__ref.getField(false,"_mpanel" /*RemoteObject*/ ).runMethod(true,"getHeight")));
 BA.debugLineNum = 147;BA.debugLine="tv.SendToBack";
Debug.ShouldStop(262144);
__ref.getField(false,"_tv" /*RemoteObject*/ ).runVoidMethod ("SendToBack");
 BA.debugLineNum = 148;BA.debugLine="Wait For Camera_SurfaceReady";
Debug.ShouldStop(524288);
parent.__c.runVoidMethod ("WaitFor","camera_surfaceready", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "camex2", "createsurface"), null);
this.state = 7;
return;
case 7:
//C
...
try {
		Debug.PushSubsStack("DataToBitmap (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,364);
...
try {
		Debug.PushSubsStack("DataToFile (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,374);
...
try {
		Debug.PushSubsStack("FloatsToList (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,511);
...
try {
		Debug.PushSubsStack("FocusAndTakePicture (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,270);
if (RapidSub.canDelegate("focusandtakepicture")) { return __ref.runUserSub(false, "camex2","focusandtakepicture", __ref, _mytaskindex);}
...
public ResumableSub_FocusAndTakePicture(com.modis.camex2 parent,RemoteObject __ref,RemoteObject _mytaskindex) {
this.parent = parent;
this.__ref = __ref;
...
Debug.ShouldStop(16384);
_previewfocusmode = BA.ObjectToString(__ref.getField(false,"_af_mode" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, __ref.runClassMethod (com.modis.camex2.class, "_getfromcapturerequest" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_previewrequest" /*RemoteObject*/ ).getObject())),(Object)(RemoteObject.createImmutable("CONTROL_AF_MODE")))))));Debug.locals.put("PreviewFocusMode", _previewfocusmode);Debug.locals.put("PreviewFocusMode", _previewfocusmode);
 BA.debugLineNum = 272;BA.debugLine="Dim PreviewAEMode As String = AE_MODE.Get(GetFrom";
Debug.ShouldStop(32768);
_previewaemode = BA.ObjectToString(__ref.getField(false,"_ae_mode" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, __ref.runClassMethod (com.modis.camex2.class, "_getfromcapturerequest" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_previewrequest" /*RemoteObject*/ ).getObject())),(Object)(RemoteObject.createImmutable("CONTROL_AE_MODE")))))));Debug.locals.put("PreviewAEMode", _previewaemode);Debug.locals.put("PreviewAEMode", _previewaemode);
...
Debug.ShouldStop(131072);
parent.__c.runVoidMethod ("LogImpl","85308420",RemoteObject.createImmutable("Focus not supported"),0);
 if (true) break;
...
_previewbuilder = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"CreatePreviewBuilder"));Debug.locals.put("PreviewBuilder", _previewbuilder);
 BA.debugLineNum = 277;BA.debugLine="PreviewSettingsMap.Put(\"CONTROL_AF_TRIGGER\", 1)";
Debug.ShouldStop(1048576);
__ref.getField(false,"_previewsettingsmap" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("CONTROL_AF_TRIGGER"))),(Object)(RemoteObject.createImmutable((1))));
 BA.debugLineNum = 278;BA.debugLine="SetSettingsFromMap(PreviewBuilder, PreviewSettin";
Debug.ShouldStop(2097152);
__ref.runClassMethod (com.modis.camex2.class, "_setsettingsfrommap" /*RemoteObject*/ ,(Object)(_previewbuilder),(Object)(__ref.getField(false,"_previewsettingsmap" /*RemoteObject*/ )));
 BA.debugLineNum = 279;BA.debugLine="Camera.AddCaptureRequest(PreviewBuilder)";
Debug.ShouldStop(4194304);
__ref.getField(false,"_camera" /*RemoteObject*/ ).runVoidMethod ("AddCaptureRequest",(Object)((_previewbuilder.getObject())));
 BA.debugLineNum = 280;BA.debugLine="Wait For (WaitForFocusWithTimeout(5000)) Complet";
Debug.ShouldStop(8388608);
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "camex2", "focusandtakepicture"), __ref.runClassMethod (com.modis.camex2.class, "_waitforfocuswithtimeout" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 5000))));
this.state = 13;
return;
case 13:
//C
...
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","85308428",RemoteObject.createImmutable("Focus failed"),0);
 if (true) break;
...
parent.__c.runVoidMethod ("LogImpl","85308430",RemoteObject.createImmutable("Focused!"),0);
 if (true) break;
...
Debug.ShouldStop(536870912);
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "camex2", "focusandtakepicture"), __ref.runClassMethod (com.modis.camex2.class, "_takepicturenow" /*RemoteObject*/ ,(Object)(_mytaskindex)));
this.state = 14;
return;
case 14:
//C
...
Debug.ShouldStop(-2147483648);
__ref.getField(false,"_previewsettingsmap" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("CONTROL_AF_TRIGGER"))),(Object)(RemoteObject.createImmutable((2))));
...
Debug.ShouldStop(4);
__ref.getField(false,"_previewsettingsmap" /*RemoteObject*/ ).runVoidMethod ("Remove",(Object)((RemoteObject.createImmutable("CONTROL_AF_TRIGGER"))));
 BA.debugLineNum = 292;BA.debugLine="Wait For (PreviewBuilder) Camera_CaptureComplete";
Debug.ShouldStop(8);
parent.__c.runVoidMethod ("WaitFor","camera_capturecomplete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "camex2", "focusandtakepicture"), (_previewbuilder.getObject()));
this.state = 15;
return;
case 15:
//C
...
try {
		Debug.PushSubsStack("getActiveArraySize (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,259);
...
Debug.ShouldStop(8);
if (true) return RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper"), __ref.runClassMethod (com.modis.camex2.class, "_getfromcameracharacteristic" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("SENSOR_INFO_ACTIVE_ARRAY_SIZE"))));
...
try {
		Debug.PushSubsStack("getAutoExposureMode (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,238);
...
Debug.ShouldStop(16384);
if (true) return __ref.runClassMethod (com.modis.camex2.class, "_inttoconst" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.modis.camex2.class, "_getfromcapturerequest" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_previewrequest" /*RemoteObject*/ ).getObject())),(Object)(RemoteObject.createImmutable("CONTROL_AE_MODE")))),(Object)(__ref.getField(false,"_ae_mode" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("getControlMode (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,242);
...
Debug.ShouldStop(262144);
if (true) return __ref.runClassMethod (com.modis.camex2.class, "_inttoconst" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.modis.camex2.class, "_getfromcapturerequest" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_previewrequest" /*RemoteObject*/ ).getObject())),(Object)(RemoteObject.createImmutable("CONTROL_MODE")))),(Object)(__ref.getField(false,"_control_mode" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("getEffectMode (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,194);
...
Debug.ShouldStop(4);
if (true) return __ref.runClassMethod (com.modis.camex2.class, "_inttoconst" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.modis.camex2.class, "_getfromcapturerequest" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_previewrequest" /*RemoteObject*/ ).getObject())),(Object)(RemoteObject.createImmutable("CONTROL_EFFECT_MODE")))),(Object)(__ref.getField(false,"_effect_mode" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("getFocusMode (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,219);
...
Debug.ShouldStop(134217728);
if (true) return __ref.runClassMethod (com.modis.camex2.class, "_inttoconst" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.modis.camex2.class, "_getfromcapturerequest" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_previewrequest" /*RemoteObject*/ ).getObject())),(Object)(RemoteObject.createImmutable("CONTROL_AF_MODE")))),(Object)(__ref.getField(false,"_af_mode" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("GetFromCameraCharacteristic (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,385);
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"GetCameraCharacteristics",(Object)(__ref.getField(true,"_id" /*RemoteObject*/ ))));Debug.locals.put("jo", _jo);
 BA.debugLineNum = 387;BA.debugLine="Return jo.RunMethod(\"get\", Array(StaticCameraChar";
Debug.ShouldStop(4);
if (true) return _jo.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("get")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.getField(false,"_staticcameracharacteristics" /*RemoteObject*/ ).runMethod(false,"GetField",(Object)(_field))})));
...
try {
		Debug.PushSubsStack("GetFromCaptureRequest (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,395);
...
Debug.ShouldStop(2048);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _capturerequest);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 397;BA.debugLine="Return jo.RunMethod(\"get\", Array(StaticCaptureReq";
Debug.ShouldStop(4096);
if (true) return _jo.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("get")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.getField(false,"_staticcapturerequest" /*RemoteObject*/ ).runMethod(false,"GetField",(Object)(_field))})));
...
try {
		Debug.PushSubsStack("GetFromCaptureResult (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,390);
...
_jresult = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _captureresult);Debug.locals.put("jresult", _jresult);
 BA.debugLineNum = 392;BA.debugLine="Return jresult.RunMethod(\"get\", Array(StaticCaptu";
Debug.ShouldStop(128);
if (true) return _jresult.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("get")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.getField(false,"_staticcaptureresult" /*RemoteObject*/ ).runMethod(false,"GetField",(Object)(_field))})));
...
try {
		Debug.PushSubsStack("GetHintOrientation (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,117);
...
Debug.ShouldStop(2097152);
_sensororientation = BA.numberCast(int.class, __ref.runClassMethod (com.modis.camex2.class, "_getfromcameracharacteristic" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("SENSOR_ORIENTATION"))));Debug.locals.put("SensorOrientation", _sensororientation);Debug.locals.put("SensorOrientation", _sensororientation);
...
Debug.ShouldStop(8388608);
if (__ref.runClassMethod (com.modis.camex2.class, "_getisfrontfacingcamera" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
...
Debug.ShouldStop(16777216);
_orientation = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_sensororientation,BA.numberCast(double.class, __ref.getField(false,"_jcamera" /*RemoteObject*/ ).runMethod(false,"GetField",(Object)(RemoteObject.createImmutable("lastKnownOrientation")))),_front,RemoteObject.createImmutable(360)}, "+*+",2, 0)),RemoteObject.createImmutable(360)}, "%",0, 0));Debug.locals.put("orientation", _orientation);Debug.locals.put("orientation", _orientation);
...
try {
		Debug.PushSubsStack("getIsFrontFacingCamera (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,381);
...
Debug.ShouldStop(536870912);
if (true) return BA.ObjectToBoolean(RemoteObject.solveBoolean("=",RemoteObject.createImmutable(0),BA.numberCast(double.class, __ref.runClassMethod (com.modis.camex2.class, "_getfromcameracharacteristic" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("LENS_FACING"))))));
...
try {
		Debug.PushSubsStack("getMaxDigitalZoom (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,228);
...
Debug.ShouldStop(16);
if (true) return BA.numberCast(float.class, __ref.runClassMethod (com.modis.camex2.class, "_getfromcameracharacteristic" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("SCALER_AVAILABLE_MAX_DIGITAL_ZOOM"))));
...
try {
		Debug.PushSubsStack("GetPreviewBitmap (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,356);
...
Debug.ShouldStop(64);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_tv" /*RemoteObject*/ ).getObject());Debug.locals.put("jo", _jo);
...
try {
		Debug.PushSubsStack("getSceneMode (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,186);
...
Debug.ShouldStop(67108864);
if (true) return __ref.runClassMethod (com.modis.camex2.class, "_inttoconst" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.modis.camex2.class, "_getfromcapturerequest" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_previewrequest" /*RemoteObject*/ ).getObject())),(Object)(RemoteObject.createImmutable("CONTROL_SCENE_MODE")))),(Object)(__ref.getField(false,"_scene_mode" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("getSupportedAutoExposureModes (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,233);
...
Debug.ShouldStop(512);
if (true) return __ref.runClassMethod (com.modis.camex2.class, "_intstoconstslist" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.modis.camex2.class, "_getfromcameracharacteristic" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("CONTROL_AE_AVAILABLE_MODES")))),(Object)(__ref.getField(false,"_ae_mode" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("getSupportedCaptureSizes (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,170);
...
Debug.ShouldStop(1024);
if (true) return __ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"GetSupportedCaptureSizes",(Object)(__ref.getField(true,"_id" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("getSupportedEffectModes (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,198);
...
Debug.ShouldStop(64);
if (true) return __ref.runClassMethod (com.modis.camex2.class, "_intstoconstslist" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.modis.camex2.class, "_getfromcameracharacteristic" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("CONTROL_AVAILABLE_EFFECTS")))),(Object)(__ref.getField(false,"_effect_mode" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("getSupportedFocusModes (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,202);
...
Debug.ShouldStop(1024);
if (true) return __ref.runClassMethod (com.modis.camex2.class, "_removeduplicates" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.modis.camex2.class, "_intstoconstslist" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.modis.camex2.class, "_getfromcameracharacteristic" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("CONTROL_AF_AVAILABLE_MODES")))),(Object)(__ref.getField(false,"_af_mode" /*RemoteObject*/ )))));
...
try {
		Debug.PushSubsStack("getSupportedHardwareLevel (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,82);
...
Debug.ShouldStop(262144);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"GetCameraCharacteristics",(Object)(BA.NumberToString(0))));Debug.locals.put("jo", _jo);
 BA.debugLineNum = 84;BA.debugLine="Return IntToConst(jo.RunMethod(\"get\", Array(Stati";
Debug.ShouldStop(524288);
if (true) return __ref.runClassMethod (com.modis.camex2.class, "_inttoconst" /*RemoteObject*/ ,(Object)(_jo.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("get")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.getField(false,"_staticcameracharacteristics" /*RemoteObject*/ ).runMethod(false,"GetField",(Object)(RemoteObject.createImmutable("INFO_SUPPORTED_HARDWARE_LEVEL")))})))),(Object)(__ref.getField(false,"_supported_hardware_level" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("getSupportedPreviewSizes (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,166);
...
Debug.ShouldStop(64);
if (true) return __ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"GetSupportedPreviewSizes",(Object)(__ref.getField(true,"_id" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("getSupportedSceneModes (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,178);
...
Debug.ShouldStop(262144);
if (true) return __ref.runClassMethod (com.modis.camex2.class, "_removeduplicates" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.modis.camex2.class, "_intstoconstslist" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (com.modis.camex2.class, "_getfromcameracharacteristic" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("CONTROL_AVAILABLE_SCENE_MODES")))),(Object)(__ref.getField(false,"_scene_mode" /*RemoteObject*/ )))));
...
try {
		Debug.PushSubsStack("getSupportedVideoSizes (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,174);
...
Debug.ShouldStop(16384);
if (true) return __ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"GetSupportedVideoSizes",(Object)(__ref.getField(true,"_id" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("Initialize (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,35);
...
Debug.ShouldStop(8);
__ref.setField ("_mpanel" /*RemoteObject*/ ,_camerapanel);
 BA.debugLineNum = 37;BA.debugLine="Camera.Initialize(\"Camera\")";
Debug.ShouldStop(16);
__ref.getField(false,"_camera" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("Camera")));
 BA.debugLineNum = 38;BA.debugLine="jcamera = Camera";
Debug.ShouldStop(32);
__ref.getField(false,"_jcamera" /*RemoteObject*/ ).setObject (__ref.getField(false,"_camera" /*RemoteObject*/ ));
 BA.debugLineNum = 39;BA.debugLine="PreviewSize.Initialize(640, 480)";
Debug.ShouldStop(64);
__ref.getField(false,"_previewsize" /*RemoteObject*/ ).runVoidMethod ("Initialize",(Object)(BA.numberCast(int.class, 640)),(Object)(BA.numberCast(int.class, 480)));
 BA.debugLineNum = 40;BA.debugLine="CaptureSize.Initialize(1920, 1080)";
Debug.ShouldStop(128);
__ref.getField(false,"_capturesize" /*RemoteObject*/ ).runVoidMethod ("Initialize",(Object)(BA.numberCast(int.class, 1920)),(Object)(BA.numberCast(int.class, 1080)));
 BA.debugLineNum = 41;BA.debugLine="StaticCaptureRequest.InitializeStatic(\"android.ha";
Debug.ShouldStop(256);
__ref.getField(false,"_staticcapturerequest" /*RemoteObject*/ ).runVoidMethod ("InitializeStatic",(Object)(RemoteObject.createImmutable("android.hardware.camera2.CaptureRequest")));
 BA.debugLineNum = 42;BA.debugLine="StaticCameraCharacteristics.InitializeStatic(\"and";
Debug.ShouldStop(512);
__ref.getField(false,"_staticcameracharacteristics" /*RemoteObject*/ ).runVoidMethod ("InitializeStatic",(Object)(RemoteObject.createImmutable("android.hardware.camera2.CameraCharacteristics")));
 BA.debugLineNum = 43;BA.debugLine="StaticCaptureResult.InitializeStatic(\"android.har";
Debug.ShouldStop(1024);
__ref.getField(false,"_staticcaptureresult" /*RemoteObject*/ ).runVoidMethod ("InitializeStatic",(Object)(RemoteObject.createImmutable("android.hardware.camera2.CaptureResult")));
 BA.debugLineNum = 44;BA.debugLine="PreviewSettingsMap.Initialize";
Debug.ShouldStop(2048);
__ref.getField(false,"_previewsettingsmap" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 45;BA.debugLine="CaptureSettingMap.Initialize";
Debug.ShouldStop(4096);
__ref.getField(false,"_capturesettingmap" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 46;BA.debugLine="bothMaps = Array(PreviewSettingsMap, CaptureSetti";
Debug.ShouldStop(8192);
__ref.setField ("_bothmaps" /*RemoteObject*/ ,camex2.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(__ref.getField(false,"_previewsettingsmap" /*RemoteObject*/ ).getObject()),(__ref.getField(false,"_capturesettingmap" /*RemoteObject*/ ).getObject())}))));
...
try {
		Debug.PushSubsStack("IntsToConstsList (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,413);
...
Debug.ShouldStop(32);
camex2.__c.runVoidMethod ("LogImpl","86160393",BA.ObjectToString(_consts),0);
 BA.debugLineNum = 423;BA.debugLine="Log(\"Unknown consts: \" & mode)";
Debug.ShouldStop(64);
camex2.__c.runVoidMethod ("LogImpl","86160394",RemoteObject.concat(RemoteObject.createImmutable("Unknown consts: "),_mode),0);
 };
 }
}Debug.locals.put("mode", _mode);
;
...
try {
		Debug.PushSubsStack("IntsToList (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,500);
...
try {
		Debug.PushSubsStack("IntToConst (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,401);
...
Debug.ShouldStop(4194304);
camex2.__c.runVoidMethod ("LogImpl","86094854",BA.ObjectToString(_consts),0);
 BA.debugLineNum = 408;BA.debugLine="Log(\"Unknown const: \" & i)";
Debug.ShouldStop(8388608);
camex2.__c.runVoidMethod ("LogImpl","86094855",RemoteObject.concat(RemoteObject.createImmutable("Unknown const: "),_i),0);
...
try {
		Debug.PushSubsStack("ObjectsToList (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,466);
...
try {
		Debug.PushSubsStack("OpenCamera (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,51);
if (RapidSub.canDelegate("opencamera")) { return __ref.runUserSub(false, "camex2","opencamera", __ref, _front);}
...
public ResumableSub_OpenCamera(com.modis.camex2 parent,RemoteObject __ref,RemoteObject _front) {
this.parent = parent;
this.__ref = __ref;
this._front = _front;
}
...
//if
this.state = 4;
if (__ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(true,"getIsCameraOpen").<Boolean>get().booleanValue()) { 
this.state = 3;
}if (true) break;
...
Debug.ShouldStop(2097152);
__ref.runClassMethod (com.modis.camex2.class, "_stop" /*RemoteObject*/ );
 if (true) break;
...
Debug.ShouldStop(8388608);
__ref.setField ("_mfront" /*RemoteObject*/ ,_front);
 BA.debugLineNum = 57;BA.debugLine="id = Camera.FindCameraId(mFront)";
Debug.ShouldStop(16777216);
__ref.setField ("_id" /*RemoteObject*/ ,__ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(true,"FindCameraId",(Object)(__ref.getField(true,"_mfront" /*RemoteObject*/ ))));
...
Debug.ShouldStop(67108864);
parent.__c.runVoidMethod ("LogImpl","83276808",RemoteObject.createImmutable("Camera not found."),0);
...
Debug.ShouldStop(536870912);
__ref.getField(false,"_camera" /*RemoteObject*/ ).runVoidMethod ("OpenCamera",(Object)(__ref.getField(true,"_id" /*RemoteObject*/ )));
 BA.debugLineNum = 63;BA.debugLine="Wait For Camera_CameraState (Open As Boolean)";
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("WaitFor","camera_camerastate", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "camex2", "opencamera"), null);
this.state = 18;
return;
case 18:
//C
...
Debug.ShouldStop(1);
parent.__c.runVoidMethod ("LogImpl","83276814",RemoteObject.createImmutable("Failed to open camera"),0);
...
//if
this.state = 17;
if (__ref.getField(true,"_printkeys" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
this.state = 14;
;}if (true) break;
...
//C
this.state = 17;
__ref.runClassMethod (com.modis.camex2.class, "_printallkeys" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"GetCameraCharacteristics",(Object)(__ref.getField(true,"_id" /*RemoteObject*/ )))),(Object)(RemoteObject.createImmutable("Camera Characteristics")));
if (true) break;
...
Debug.ShouldStop(16);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(__ref.getField(true,"_taskindex" /*RemoteObject*/ )));return;};
...
try {
		Debug.PushSubsStack("PrepareSurface (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,89);
if (RapidSub.canDelegate("preparesurface")) { return __ref.runUserSub(false, "camex2","preparesurface", __ref, _mytaskindex);}
...
public ResumableSub_PrepareSurface(com.modis.camex2 parent,RemoteObject __ref,RemoteObject _mytaskindex) {
this.parent = parent;
this.__ref = __ref;
this._mytaskindex = _mytaskindex;
}
...
//if
this.state = 6;
if (RemoteObject.solveBoolean("!",_mytaskindex,BA.numberCast(double.class, __ref.getField(true,"_taskindex" /*RemoteObject*/ )))) { 
this.state = 3;
;}if (true) break;
...
Debug.ShouldStop(67108864);
__ref.runClassMethod (com.modis.camex2.class, "_closesession" /*RemoteObject*/ );
 BA.debugLineNum = 92;BA.debugLine="Wait For (CreateSurface) Complete (Result As Bool";
Debug.ShouldStop(134217728);
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "camex2", "preparesurface"), __ref.runClassMethod (com.modis.camex2.class, "_createsurface" /*RemoteObject*/ ));
this.state = 19;
return;
case 19:
//C
...
Debug.ShouldStop(536870912);
__ref.getField(false,"_camera" /*RemoteObject*/ ).runVoidMethod ("StartSession",(Object)((__ref.getField(false,"_tv" /*RemoteObject*/ ).getObject())),(Object)(__ref.getField(false,"_previewsize" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_capturesize" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 256)),(Object)(BA.numberCast(int.class, 0)),(Object)(parent.__c.getField(true,"False")));
 BA.debugLineNum = 95;BA.debugLine="Wait For Camera_SessionConfigured (Success As Boo";
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("WaitFor","camera_sessionconfigured", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "camex2", "preparesurface"), null);
this.state = 20;
return;
case 20:
//C
...
try {
		Debug.PushSubsStack("PrepareSurfaceForVideo (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,103);
if (RapidSub.canDelegate("preparesurfaceforvideo")) { return __ref.runUserSub(false, "camex2","preparesurfaceforvideo", __ref, _mytaskindex, _dir, _filename);}
...
public ResumableSub_PrepareSurfaceForVideo(com.modis.camex2 parent,RemoteObject __ref,RemoteObject _mytaskindex,RemoteObject _dir,RemoteObject _filename) {
this.parent = parent;
this.__ref = __ref;
this._mytaskindex = _mytaskindex;
this._dir = _dir;
...
Debug.ShouldStop(512);
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "camex2", "preparesurfaceforvideo"), __ref.runClassMethod (com.modis.camex2.class, "_createsurface" /*RemoteObject*/ ));
this.state = 19;
return;
case 19:
//C
...
Debug.ShouldStop(4096);
__ref.getField(false,"_mediarecorder" /*RemoteObject*/ ).setObject (__ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"CreateMediaRecorder",(Object)(__ref.getField(false,"_previewsize" /*RemoteObject*/ )),(Object)(_dir),(Object)(_filename)));
 BA.debugLineNum = 110;BA.debugLine="MediaRecorder.RunMethod(\"setOrientationHint\", Arr";
Debug.ShouldStop(8192);
__ref.getField(false,"_mediarecorder" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setOrientationHint")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(__ref.runClassMethod (com.modis.camex2.class, "_gethintorientation" /*RemoteObject*/ ))})));
 BA.debugLineNum = 111;BA.debugLine="Camera.StartSession(tv, PreviewSize, CaptureSize,";
Debug.ShouldStop(16384);
__ref.getField(false,"_camera" /*RemoteObject*/ ).runVoidMethod ("StartSession",(Object)((__ref.getField(false,"_tv" /*RemoteObject*/ ).getObject())),(Object)(__ref.getField(false,"_previewsize" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_capturesize" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(parent.__c.getField(true,"True")));
 BA.debugLineNum = 112;BA.debugLine="Wait For Camera_SessionConfigured (Success As Boo";
Debug.ShouldStop(32768);
parent.__c.runVoidMethod ("WaitFor","camera_sessionconfigured", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "camex2", "preparesurfaceforvideo"), null);
this.state = 20;
return;
case 20:
//C
...
try {
		Debug.PushSubsStack("PrintAllKeys (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,444);
...
Debug.ShouldStop(268435456);
camex2.__c.runVoidMethod ("LogImpl","86356993",(RemoteObject.concat(RemoteObject.createImmutable("******  "),camex2.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_title))),RemoteObject.createImmutable(" **********"))),0);
 BA.debugLineNum = 446;BA.debugLine="Dim jo As JavaObject = CameraMap";
Debug.ShouldStop(536870912);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _cameramap);Debug.locals.put("jo", _jo);
...
_keys = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _jo.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getKeys")),(Object)((camex2.__c.getField(false,"Null")))));Debug.locals.put("keys", _keys);
...
_k = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), group4.runMethod(false,"Get",index4));
...
Debug.ShouldStop(16);
_value = (__ref.runClassMethod (com.modis.camex2.class, "_floatstolist" /*RemoteObject*/ ,(Object)(_value)).getObject());Debug.locals.put("value", _value);
 }else 
...
Debug.ShouldStop(64);
_value = (__ref.runClassMethod (com.modis.camex2.class, "_intstolist" /*RemoteObject*/ ,(Object)(_value)).getObject());Debug.locals.put("value", _value);
 }else 
...
Debug.ShouldStop(256);
_value = (__ref.runClassMethod (com.modis.camex2.class, "_boolstolist" /*RemoteObject*/ ,(Object)(_value)).getObject());Debug.locals.put("value", _value);
 }else 
...
Debug.ShouldStop(1024);
_value = (__ref.runClassMethod (com.modis.camex2.class, "_bytestolist" /*RemoteObject*/ ,(Object)(_value)).getObject());Debug.locals.put("value", _value);
 }else 
...
Debug.ShouldStop(4096);
_value = (__ref.runClassMethod (com.modis.camex2.class, "_objectstolist" /*RemoteObject*/ ,(Object)(_value)).getObject());Debug.locals.put("value", _value);
 }}}}}
;
 BA.debugLineNum = 463;BA.debugLine="Log($\"${k.RunMethod(\"getName\", Null)}: ${value}\"";
Debug.ShouldStop(16384);
camex2.__c.runVoidMethod ("LogImpl","86357011",(RemoteObject.concat(RemoteObject.createImmutable(""),camex2.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)(_k.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getName")),(Object)((camex2.__c.getField(false,"Null")))))),RemoteObject.createImmutable(": "),camex2.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)(_value)),RemoteObject.createImmutable(""))),0);
 }
}Debug.locals.put("k", _k);
;
...
try {
		Debug.PushSubsStack("RemoveDuplicates (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,206);
...
try {
		Debug.PushSubsStack("setAutoExposureMode (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,245);
...
Debug.ShouldStop(2097152);
__ref.runClassMethod (com.modis.camex2.class, "_setbothmaps" /*RemoteObject*/ ,(Object)(BA.ObjectToString("CONTROL_AE_MODE")),(Object)((__ref.getField(false,"_ae_mode" /*RemoteObject*/ ).runMethod(true,"IndexOf",(Object)((_mode))))));
 BA.debugLineNum = 247;BA.debugLine="PreviewSettingsMap.Put(\"FLASH_MODE\", FLASH_MODE.I";
Debug.ShouldStop(4194304);
__ref.getField(false,"_previewsettingsmap" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("FLASH_MODE"))),(Object)((__ref.getField(false,"_flash_mode" /*RemoteObject*/ ).runMethod(true,"IndexOf",(Object)((RemoteObject.createImmutable("OFF")))))));
...
Debug.ShouldStop(16777216);
__ref.getField(false,"_capturesettingmap" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("FLASH_MODE"))),(Object)((__ref.getField(false,"_flash_mode" /*RemoteObject*/ ).runMethod(true,"IndexOf",(Object)((RemoteObject.createImmutable("SINGLE")))))));
 };
...
try {
		Debug.PushSubsStack("SetBothMaps (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,263);
...
{
final RemoteObject group1 = __ref.getField(false,"_bothmaps" /*RemoteObject*/ );
final int groupLen1 = group1.runMethod(true,"getSize").<Integer>get()
;int index1 = 0;
;
for (; index1 < groupLen1;index1++){
_m = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), group1.runMethod(false,"Get",index1));
...
try {
		Debug.PushSubsStack("setEffectMode (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,190);
...
Debug.ShouldStop(1073741824);
__ref.runClassMethod (com.modis.camex2.class, "_setbothmaps" /*RemoteObject*/ ,(Object)(BA.ObjectToString("CONTROL_EFFECT_MODE")),(Object)((__ref.getField(false,"_effect_mode" /*RemoteObject*/ ).runMethod(true,"IndexOf",(Object)((_mode))))));
...
try {
		Debug.PushSubsStack("setFocusMode (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,223);
...
Debug.ShouldStop(-2147483648);
__ref.runClassMethod (com.modis.camex2.class, "_setbothmaps" /*RemoteObject*/ ,(Object)(BA.ObjectToString("CONTROL_AF_MODE")),(Object)((__ref.getField(false,"_af_mode" /*RemoteObject*/ ).runMethod(true,"IndexOf",(Object)((_mode))))));
...
try {
		Debug.PushSubsStack("setPreviewCropRegion (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,254);
...
Debug.ShouldStop(1073741824);
__ref.getField(false,"_previewsettingsmap" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("SCALER_CROP_REGION"))),(Object)((_r.getObject())));
...
try {
		Debug.PushSubsStack("setSceneMode (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,182);
...
Debug.ShouldStop(4194304);
__ref.runClassMethod (com.modis.camex2.class, "_setbothmaps" /*RemoteObject*/ ,(Object)(BA.ObjectToString("CONTROL_SCENE_MODE")),(Object)((__ref.getField(false,"_scene_mode" /*RemoteObject*/ ).runMethod(true,"IndexOf",(Object)((_mode))))));
...
try {
		Debug.PushSubsStack("SetSettingsFromMap (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,429);
...
Debug.ShouldStop(16384);
_builder.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("set")),(Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {__ref.getField(false,"_staticcapturerequest" /*RemoteObject*/ ).runMethod(false,"GetField",(Object)(_key)),_m.runMethod(false,"Get",(Object)((_key)))})));
 }
}Debug.locals.put("key", _key);
;
...
try {
		Debug.PushSubsStack("StartPreview (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,153);
...
Debug.ShouldStop(134217728);
_previewbuilder = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"CreateVideoRequestBuilder"));
 }else {
 BA.debugLineNum = 158;BA.debugLine="PreviewBuilder = Camera.CreatePreviewBuilder";
Debug.ShouldStop(536870912);
_previewbuilder = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"CreatePreviewBuilder"));
 };
...
Debug.ShouldStop(1);
__ref.getField(false,"_previewrequest" /*RemoteObject*/ ).setObject (__ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"SetRepeatingRequest",(Object)((_previewbuilder.getObject()))));
 BA.debugLineNum = 162;BA.debugLine="If PrintKeys Then PrintAllKeys(PreviewRequest, \"P";
Debug.ShouldStop(2);
if (__ref.getField(true,"_printkeys" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
__ref.runClassMethod (com.modis.camex2.class, "_printallkeys" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_previewrequest" /*RemoteObject*/ ).getObject())),(Object)(RemoteObject.createImmutable("Preview Capture Request")));};
...
try {
		Debug.PushSubsStack("StartVideoRecording (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,126);
...
Debug.ShouldStop(-2147483648);
__ref.getField(false,"_mediarecorder" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("start")),(Object)((camex2.__c.getField(false,"Null"))));
 BA.debugLineNum = 129;BA.debugLine="RecordingVideo = True";
Debug.ShouldStop(1);
__ref.setField ("_recordingvideo" /*RemoteObject*/ ,camex2.__c.getField(true,"True"));
...
try {
		Debug.PushSubsStack("Stop (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,435);
...
Debug.ShouldStop(524288);
__ref.setField ("_recordingvideo" /*RemoteObject*/ ,camex2.__c.getField(true,"False"));
 BA.debugLineNum = 437;BA.debugLine="Camera.Stop";
Debug.ShouldStop(1048576);
__ref.getField(false,"_camera" /*RemoteObject*/ ).runVoidMethod ("Stop");
...
try {
		Debug.PushSubsStack("StopVideoRecording (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,133);
...
Debug.ShouldStop(128);
__ref.getField(false,"_mediarecorder" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("stop")),(Object)((camex2.__c.getField(false,"Null"))));
...
Debug.ShouldStop(512);
camex2.__c.runVoidMethod ("LogImpl","83735557",BA.ObjectToString(camex2.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("TakePictureNow (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,315);
if (RapidSub.canDelegate("takepicturenow")) { return __ref.runUserSub(false, "camex2","takepicturenow", __ref, _mytaskindex);}
...
public ResumableSub_TakePictureNow(com.modis.camex2 parent,RemoteObject __ref,RemoteObject _mytaskindex) {
this.parent = parent;
this.__ref = __ref;
this._mytaskindex = _mytaskindex;
}
...
Debug.ShouldStop(268435456);
__ref.getField(false,"_camera" /*RemoteObject*/ ).runVoidMethod ("AbortCaptures");
...
_builder = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"CreateCaptureBuilder"));Debug.locals.put("builder", _builder);
 BA.debugLineNum = 319;BA.debugLine="CaptureSettingMap.Put(\"JPEG_ORIENTATION\", GetHint";
Debug.ShouldStop(1073741824);
__ref.getField(false,"_capturesettingmap" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("JPEG_ORIENTATION"))),(Object)((__ref.runClassMethod (com.modis.camex2.class, "_gethintorientation" /*RemoteObject*/ ))));
 BA.debugLineNum = 320;BA.debugLine="SetSettingsFromMap(builder, CaptureSettingMap)";
Debug.ShouldStop(-2147483648);
__ref.runClassMethod (com.modis.camex2.class, "_setsettingsfrommap" /*RemoteObject*/ ,(Object)(_builder),(Object)(__ref.getField(false,"_capturesettingmap" /*RemoteObject*/ )));
 BA.debugLineNum = 321;BA.debugLine="Dim CaptureRequest As Object = Camera.AddCaptureR";
Debug.ShouldStop(1);
_capturerequest = __ref.getField(false,"_camera" /*RemoteObject*/ ).runMethod(false,"AddCaptureRequest",(Object)((_builder.getObject())));Debug.locals.put("CaptureRequest", _capturerequest);Debug.locals.put("CaptureRequest", _capturerequest);
...
//C
this.state = 12;
__ref.runClassMethod (com.modis.camex2.class, "_printallkeys" /*RemoteObject*/ ,(Object)(_capturerequest),(Object)(RemoteObject.createImmutable("Capture Request")));
if (true) break;
...
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("WaitFor","camera_picturetaken", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "camex2", "takepicturenow"), null);
this.state = 13;
return;
case 13:
//C
...
Debug.ShouldStop(8);
__ref.runClassMethod (com.modis.camex2.class, "_startpreview" /*RemoteObject*/ ,(Object)(_mytaskindex),(Object)(parent.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("TakePicturesNow (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,334);
if (RapidSub.canDelegate("takepicturesnow")) { return __ref.runUserSub(false, "camex2","takepicturesnow", __ref, _mytaskindex, _numberofpictures);}
...
public ResumableSub_TakePicturesNow(com.modis.camex2 parent,RemoteObject __ref,RemoteObject _mytaskindex,RemoteObject _numberofpictures) {
this.parent = parent;
this.__ref = __ref;
this._mytaskindex = _mytaskindex;
...
Debug.ShouldStop(4194304);
__ref.getField(false,"_camera" /*RemoteObject*/ ).runVoidMethod ("AddCaptureRequest",(Object)((_builder.getObject())));
 if (true) break;
if (true) break;
Debug.locals.put("i", _i);
;
...
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("WaitFor","camera_picturetaken", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "camex2", "takepicturesnow"), null);
this.state = 18;
return;
case 18:
//C
...
try {
		Debug.PushSubsStack("WaitForFocusWithTimeout (camex2) ","camex2",6,__ref.getField(false, "ba"),__ref,299);
if (RapidSub.canDelegate("waitforfocuswithtimeout")) { return __ref.runUserSub(false, "camex2","waitforfocuswithtimeout", __ref, _timeoutms);}
...
public ResumableSub_WaitForFocusWithTimeout(com.modis.camex2 parent,RemoteObject __ref,RemoteObject _timeoutms) {
this.parent = parent;
this.__ref = __ref;
...
//do until
this.state = 10;
while (!(RemoteObject.solveBoolean("=",__ref.getField(true,"_focusstate" /*RemoteObject*/ ),BA.ObjectToString("FOCUSED_LOCKED")) || RemoteObject.solveBoolean("=",__ref.getField(true,"_focusstate" /*RemoteObject*/ ),BA.ObjectToString("NOT_FOCUSED_LOCKED")))) {
this.state = 3;
if (true) break;
}
if (true) break;
...
Debug.ShouldStop(8192);
parent.__c.runVoidMethod ("Sleep",__ref.getField(false, "ba"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "camex2", "waitforfocuswithtimeout"),BA.numberCast(int.class, 50));
this.state = 11;
return;
case 11:
//C
...
//if
this.state = 9;
if (RemoteObject.solveBoolean(">",RemoteObject.solve(new RemoteObject[] {parent.__c.getField(false,"DateTime").runMethod(true,"getNow"),_start}, "-",1, 2),BA.numberCast(long.class, _timeoutms))) { 
this.state = 6;
;}if (true) break;
...
Debug.ShouldStop(65536);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,RemoteObject.createImmutable((RemoteObject.solveBoolean("=",__ref.getField(true,"_focusstate" /*RemoteObject*/ ),BA.ObjectToString("FOCUSED_LOCKED")))));return;};
