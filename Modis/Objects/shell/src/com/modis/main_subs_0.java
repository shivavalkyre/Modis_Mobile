...
_parameter = RemoteObject.concat(RemoteObject.createImmutable("nik="),parent.mostCurrent._edittext1.runMethod(true,"getText"),RemoteObject.createImmutable("&password="),parent.mostCurrent._edittext2.runMethod(true,"getText"));Debug.locals.put("parameter", _parameter);Debug.locals.put("parameter", _parameter);
 BA.debugLineNum = 67;BA.debugLine="Dim param As String = \"{\" & \"\"\"\" & \"nik\" & \"\"\"\"";
Debug.ShouldStop(4);
_param = RemoteObject.concat(RemoteObject.createImmutable("{"),RemoteObject.createImmutable("\""),RemoteObject.createImmutable("nik"),RemoteObject.createImmutable("\""),RemoteObject.createImmutable(":"),RemoteObject.createImmutable("\""),parent.mostCurrent._edittext1.runMethod(true,"getText"),RemoteObject.createImmutable("\""),RemoteObject.createImmutable(","),RemoteObject.createImmutable("\""),RemoteObject.createImmutable("password"),RemoteObject.createImmutable("\""),RemoteObject.createImmutable(":"),RemoteObject.createImmutable("\""),parent.mostCurrent._edittext2.runMethod(true,"getText"),RemoteObject.createImmutable("\""),RemoteObject.createImmutable("}"));Debug.locals.put("param", _param);Debug.locals.put("param", _param);
 BA.debugLineNum = 68;BA.debugLine="Log(param)";
Debug.ShouldStop(8);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","8327687",_param,0);
 BA.debugLineNum = 73;BA.debugLine="Log(parameter)";
Debug.ShouldStop(256);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","8327692",_parameter,0);
 BA.debugLineNum = 74;BA.debugLine="j.Initialize(\"j\",Me)";
...
_j.runClassMethod (com.modis.httpjob.class, "_initialize" /*RemoteObject*/ ,main.processBA,(Object)(BA.ObjectToString("j")),(Object)(main.getObject()));
 BA.debugLineNum = 75;BA.debugLine="j.PostString (url_login,param)";
Debug.ShouldStop(1024);
_j.runClassMethod (com.modis.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(parent._url_login),(Object)(_param));
 BA.debugLineNum = 76;BA.debugLine="Wait For (j) JobDone(j As HttpJob)";
Debug.ShouldStop(2048);
...
//C
this.state = 9;
 BA.debugLineNum = 78;BA.debugLine="Log(j.GetString)";
Debug.ShouldStop(8192);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","8327697",_j.runClassMethod (com.modis.httpjob.class, "_getstring" /*RemoteObject*/ ),0);
 BA.debugLineNum = 79;BA.debugLine="Dim result As String = j.GetString";
Debug.ShouldStop(16384);
_result = _j.runClassMethod (com.modis.httpjob.class, "_getstring" /*RemoteObject*/ );Debug.locals.put("result", _result);Debug.locals.put("result", _result);
 BA.debugLineNum = 87;BA.debugLine="StartActivity(Home)";
Debug.ShouldStop(4194304);
...
//C
this.state = 9;
 BA.debugLineNum = 93;BA.debugLine="Log(j.ErrorMessage)";
Debug.ShouldStop(268435456);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","8327712",_j.getField(true,"_errormessage" /*RemoteObject*/ ),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("Label6_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,99);
...
Debug.ShouldStop(4);
 BA.debugLineNum = 100;BA.debugLine="StartActivity(Register)";
Debug.ShouldStop(8);
