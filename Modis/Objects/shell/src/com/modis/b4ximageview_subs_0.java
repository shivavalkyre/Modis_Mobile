...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.modis.b4ximageview.class, "_update" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.modis.b4ximageview.class, "_updateclip" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
b4ximageview.__c.runVoidMethod ("LogImpl","917498139",RemoteObject.concat(RemoteObject.createImmutable("Invalid resize mode: "),__ref.getField(true,"_mresizemode" /*RemoteObject*/ )),0);
 break; }
}
;
