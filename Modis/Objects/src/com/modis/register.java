...
public class register extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "com.modis", "com.modis.register");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.modis", "com.modis.register");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.modis.register", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public anywheresoftware.b4a.objects.PanelWrapper _panelmessage = null;
...
RDebugUtils.currentLine=1114114;
 //BA.debugLineNum = 1114114;BA.debugLine="Dim jo As JavaObject";
_jo = new anywheresoftware.b4j.object.JavaObject();
RDebugUtils.currentLine=1114115;
 //BA.debugLineNum = 1114115;BA.debugLine="Dim window As JavaObject = jo.InitializeContext.R";
...
RDebugUtils.currentLine=1114116;
 //BA.debugLineNum = 1114116;BA.debugLine="window.RunMethod(\"addFlags\", Array(Bit.Or(0x00000";
...
RDebugUtils.currentLine=1114117;
 //BA.debugLineNum = 1114117;BA.debugLine="Activity.Height = Activity.Height + 24dip";
...
RDebugUtils.currentLine=1114118;
 //BA.debugLineNum = 1114118;BA.debugLine="Activity.LoadLayout(\"Register\")";
mostCurrent._activity.LoadLayout("Register",mostCurrent.activityBA);
RDebugUtils.currentLine=1114120;
 //BA.debugLineNum = 1114120;BA.debugLine="general.SetBackgroundTintList(EditText1,Colors.Wh";
...
RDebugUtils.currentLine=1114121;
 //BA.debugLineNum = 1114121;BA.debugLine="general.SetBackgroundTintList(EditText2,Colors.Wh";
...
RDebugUtils.currentLine=1114122;
 //BA.debugLineNum = 1114122;BA.debugLine="general.SetBackgroundTintList(EditText3,Colors.Wh";
...
RDebugUtils.currentLine=1114123;
 //BA.debugLineNum = 1114123;BA.debugLine="general.SetBackgroundTintList(EditText4,Colors.Wh";
...
RDebugUtils.currentLine=1376257;
 //BA.debugLineNum = 1376257;BA.debugLine="PanelMessage.SetVisibleAnimated(200,True)";
mostCurrent._panelmessage.SetVisibleAnimated((int) (200),anywheresoftware.b4a.keywords.Common.True);
...
RDebugUtils.currentLine=1441793;
 //BA.debugLineNum = 1441793;BA.debugLine="PanelMessage.SetVisibleAnimated(200,False)";
mostCurrent._panelmessage.SetVisibleAnimated((int) (200),anywheresoftware.b4a.keywords.Common.False);
...
RDebugUtils.currentModule="register";
if (Debug.shouldDelegate(mostCurrent.activityBA, "label10_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "label10_click", null));}
RDebugUtils.currentLine=1507328;
 //BA.debugLineNum = 1507328;BA.debugLine="Private Sub Label10_Click";
RDebugUtils.currentLine=1507329;
 //BA.debugLineNum = 1507329;BA.debugLine="PanelMessage.SetVisibleAnimated(200,False)";
mostCurrent._panelmessage.SetVisibleAnimated((int) (200),anywheresoftware.b4a.keywords.Common.False);
...
RDebugUtils.currentLine=1310720;
 //BA.debugLineNum = 1310720;BA.debugLine="Private Sub Label7_Click";
...
public static String  _panelmessage_touch(int _action,float _x,float _y) throws Exception{
RDebugUtils.currentModule="register";
if (Debug.shouldDelegate(mostCurrent.activityBA, "panelmessage_touch", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "panelmessage_touch", new Object[] {_action,_x,_y}));}
RDebugUtils.currentLine=1572864;
 //BA.debugLineNum = 1572864;BA.debugLine="Private Sub PanelMessage_Touch (Action As Int, X A";
